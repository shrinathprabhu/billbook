...
// Keep canonical signals in the browser-normalized root URL form.
export const SITE_URL = 'https://billbook.lowkey.tools/';
export const REPOSITORY_URL = 'https://github.com/shrinathprabhu/billbook';
...
// One relevant recommendation, shared by the footer and public text guide.
export const relatedTools = [
  {
    name: 'Credo',
    url: 'https://lowkey.tools/credo',
    title: 'Some details deserve an envelope.',
    text: 'Share a password or sensitive file through an encrypted, expiring link.',
    action: 'Seal it with Credo',
  },
];
...
export const faqs = [
  {
    question: 'Can I install Billbook as an app?',
    answer:
